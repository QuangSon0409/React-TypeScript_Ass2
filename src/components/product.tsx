const Product = () => {
  return (
    <div className="w-full max-w-sm ml-[-30px] items-center ">
      ...
      <div className="px-5 pb-5 ml-[30px]">
        <a href="#">
        ...
        <div className="flex items-center mt-2.5 mb-5">
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5  ml-3">
            5.0
          </span>
        </div>
      </div>
